...
- Копии/Масштаб/Страницы/Дуплекс — рабочие, оставить.
- Реализовать открытый вопрос из `ui-spec.md §6` (спрятать Страницы/дуплекс под «Дополнительно»
  или оставить) — **согласовать с владельцем перед реализацией**.
